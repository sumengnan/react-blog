...
module.exports = function(webpackEnv) {
  ...
  return {
    ...
    plugins: [
      ...
      // 内联 webpack 运行时脚本。此脚本太小，无法保证网络请求。
      ...
      // 这为模块未找到的错误提供了一些必要的上下文，例如：请求的资源。
...
/*       new AutoDllPlugin({
      ...
      //或者手动添加<script src="./static/dll.js"></script>
      new AddAssetHtmlPlugin([
        {
          // dll文件位置
          filepath: path.resolve(__dirname, '../dll/react_redux.js')
          // dll 引用路径
          //publicPath: './static/',
    ...
    //有些库导入节点模块，但不在浏览器中使用它们。告诉Webpack为他们提供空的模拟，以便导入它们。
    node: {
      module: 'empty',
      dgram: 'empty',
      dns: 'mock',
    ...
    // 关闭性能处理，因为我们利用了我们自己通过FileSizeReporter提供的提示
    performance: false
  }
}
